...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $casteno          = mysqli_real_escape_string($conn, $_POST['casteno']);
    // Bank Details fix
    ...
    $sql = "INSERT INTO newadmissions (
        ...
        religion, sssm_id, family_id, aadhar_no, category, caste,caste_certificate_no, ac_holdername, 
        ...
        '$religion', '$sssm_id', '$family_id', '$aadhar_no', '$category', '$caste','$casteno', '$ac_holdername', 
        '$bank_name', '$account_no', '$ifsc_code', '$student_class', '$section', '$payment_mode', 
